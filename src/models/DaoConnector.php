 ...
 * models.
 *
 * It is based on the basic assumption that a model class (under Website\models)
 * using this trait has a corresponding DatabaseModel under Website\models\dao.
...
trait DaoConnector
{
    ...
    {
        if (!self::$dao) {
            $base_class = substr(get_called_class(), strlen('Website\\models\\'));
            $dao_class_name = "\\Website\\models\\dao\\{$base_class}";
